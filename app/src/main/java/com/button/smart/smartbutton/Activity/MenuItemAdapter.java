...
public class MenuItemAdapter extends BaseAdapter{
    ...
    private List<LvMenuItem> mItems = new ArrayList<LvMenuItem>(
            Arrays.asList(
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Home"),
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Messages"),
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Friends"),
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Discussion"),
                    new LvMenuItem(),
                    new LvMenuItem("Sub Items"),
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Sub Item 1"),
                    new LvMenuItem(R.drawable.btn_list_hire_selected, "Sub Item 2")
            ));
